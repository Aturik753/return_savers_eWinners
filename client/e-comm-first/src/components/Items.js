...
<section class="container">
  ...
  <div class="card h-100">
    ...
    <div class="card-body">
      ...
      <h6>$100.00</h6>
      <p class="card-text">Track your workout with heart monitor, distance tracking and more.</p>
    </div>
...
<div class="col">
  <div class="card h-100">
    ...
    <div class="card-body">
      ...
      <h6>$40.00</h6>
      <p class="card-text">Leather tablet pad for up to 17" laptops</p>
    </div>
    <div class="card-footer">
      <button type="button" class="btn btn-primary">Add to Cart</button>
    </div>
...
<div class="col">
  <div class="card h-100">
    ...
    <div class="card-body">
      ...
      <h6>$100.00</h6>
      <p class="card-text">Back pack converts to hand bag</p>
    </div>
    <div class="card-footer">
      <button type="button" class="btn btn-primary">Add to Cart</button>
    </div>
...
<div class="col">
  <div class="card h-100">
    ...
    <div class="card-body">
      ...
      <h6>$68.00</h6>
      <p class="card-text">3 button golf shirt - slate blue</p>
    </div>
    <div class="card-footer">
...
<div class="col">
  <div class="card h-100">
    ...
    <div class="card-body">
      ...
      <h6>$85.00</h6>
      <p class="card-text">Denim shorts mid thigh cut</p>
    </div>
    <div class="card-footer">
      <button type="button" class="btn btn-primary">Add to Cart</button>
    </div>
...
<div class="col">
  <div class="card h-100">
    ...
    <div class="card-body">
      ...
      <h6>$180.00</h6>
      <p class="card-text">Down with durable canvas outer</p>
    </div>
    <div class="card-footer">
      <button type="button" class="btn btn-primary">Add to Cart</button>
    </div>
